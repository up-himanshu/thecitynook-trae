  ...
  return (
    <div className="space-y-4 lg:col-span-2">
      ...
      <p className="text-gray-600 leading-relaxed" itemProp="description">
        ...
        high-speed Wi-Fi, air conditioning, and a flat-screen TV. Take advantage
        of the clubhouse with a pool table and table tennis. Just moments away
        from top attractions, dining, and nightlife, this studio offers a
        stylish and convenient base for a memorable and comfortable experience.
      </p>
      <div className="mt-6">
        ...
        >
          ...
          <span itemProp="value">
            Guests have full access to the studio apartment during their stay.
            You can easily reach the studio using the lift, ensuring a smooth
            arrival. The studio is private and self-contained, offering you a
            comfortable and relaxing space. Additionally, you can enjoy the
            clubhouse, which features a pool table and table tennis, subject to
            operating hours. Please check the timings for clubhouse access
            during your stay. We strive to make your experience as enjoyable and
